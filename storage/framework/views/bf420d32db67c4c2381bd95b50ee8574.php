...
<?php $__env->startSection('content'); ?>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="<?php echo e(route('pendapatan.create')); ?>" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                : '-'); ?>
                                                    ...
                                                    <!-- AKSI -->
                                                    <td class="text-center">
                                                        <a href="<?php echo e(route('pendapatan.show', $item->id)); ?>" class="btn btn-info btn-sm p-1">
                                                            <i class="fas fa-eye"></i>
                                                        </a>

                                                        <a href="<?php echo e(route('pendapatan.edit', $item->id)); ?>" class="btn btn-warning btn-sm p-1">

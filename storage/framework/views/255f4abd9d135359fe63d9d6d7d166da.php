<?php $__env->startSection('content'); ?>
    ...
    <div class="db-header a1">
        <div style="position:relative;z-index:1;">
            ...
            <h1>Selamat datang,<br><?php echo e(Auth::user()->name ?? 'Admin'); ?> 👋</h1>
            <p class="sub">
            ...
            <div class="actions">
                <a href="<?php echo e(route('pendapatan.create')); ?>" class="btn-action btn-income">
                    <i class="fas fa-plus-circle"></i> Pendapatan
                </a>
                <a href="<?php echo e(route('belanja.create')); ?>" class="btn-action btn-expense">
    ...
    <div class="kpi-grid a2">
        ...
        <div class="kpi-card green">
            ...
            <div>
                ...
                <div class="kpi-val">Rp <?php echo e(number_format($totalRealisasiPendapatan + $totalRealisasiBelanja)); ?></div>
                <div class="kpi-note">Pendapatan + Belanja</div>
            </div>
        </div>
        <div class="kpi-card blue">
            ...
            <div class="s-head">
                <div style="display:flex;align-items:center;gap:10px;">
                    ...
                    <div>
                        ...
                        <p class="s-sub">Perbandingan anggaran <?php echo e(date('Y')); ?></p>
                    </div>
                </div>
            </div>
            <div class="chart-card">
        ...
        <div class="s-head">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                    ...
                    <p class="s-sub">Tahun <?php echo e(date('Y')); ?></p>
                </div>
            </div>
        </div>
        <div class="prog-section">
            <div class="prog-item">
                <div class="prog-lbl">
                    ...
                    $clsP = $pctP >= 75 ? 'pct-hi' : ($pctP >= 40 ? 'pct-mid' : 'pct-lo'); ?>
                    <span class="pct-badge <?php echo e($clsP); ?>"><?php echo e(number_format($pctP, 2)); ?>%</span>
                </div>
                <div class="progress">
                    <div class="progress-bar" style="width:<?php echo e(min($pctP, 100)); ?>%;background:var(--blue);"></div>
                </div>
                <div
                    style="display:flex;justify-content:space-between;font-size:.67rem;color:var(--gray-400);margin-top:4px;">
                    <span>Rp <?php echo e(number_format($totalRealisasiPendapatan)); ?> terealisasi</span>
                    <span>Pagu: Rp <?php echo e(number_format($totalPaguPendapatan)); ?></span>
                </div>
            </div>
            <div class="prog-item">
                <div class="prog-lbl">
                    ...
                    $clsB = $pctB >= 75 ? 'pct-hi' : ($pctB >= 40 ? 'pct-mid' : 'pct-lo'); ?>
                    <span class="pct-badge <?php echo e($clsB); ?>"><?php echo e(number_format($pctB, 2)); ?>%</span>
                </div>
                <div class="progress">
                    <div class="progress-bar" style="width:<?php echo e(min($pctB, 100)); ?>%;background:var(--green);"></div>
                </div>
                <div
                    style="display:flex;justify-content:space-between;font-size:.67rem;color:var(--gray-400);margin-top:4px;">
                    <span>Rp <?php echo e(number_format($totalRealisasiBelanja)); ?> terealisasi</span>
                    <span>Pagu: Rp <?php echo e(number_format($totalPaguBelanja)); ?></span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="sum-card blue">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px;">
                ...
                <div>
                    ...
                    <p class="s-sub">Realisasi <?php echo e(number_format($persenPendapatan, 2)); ?>% dari pagu</p>
                </div>
            </div>
            <div class="sum-pill-row">
                <div class="sum-pill blue">
                    <span class="sum-pill-lbl">Pagu</span>
                    <span class="sum-pill-val">Rp <?php echo e(number_format($totalPaguPendapatan)); ?></span>
                </div>
                <div class="sum-pill blue">
                    <span class="sum-pill-lbl">Realisasi</span>
                    <span class="sum-pill-val">Rp <?php echo e(number_format($totalRealisasiPendapatan)); ?></span>
                </div>
                <div class="sum-pill blue">
                    <span class="sum-pill-lbl">Sisa</span>
                    <span class="sum-pill-val" style="color:#e02424;">Rp <?php echo e(number_format($totalSisaPendapatan)); ?></span>
                </div>
            </div>
        ...
        <div class="sum-card green">
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:6px;">
                ...
                <div>
                    ...
                    <p class="s-sub">Realisasi <?php echo e(number_format($persenBelanja, 2)); ?>% dari pagu</p>
                </div>
            </div>
            <div class="sum-pill-row">
                <div class="sum-pill green">
                    <span class="sum-pill-lbl">Pagu</span>
                    <span class="sum-pill-val">Rp <?php echo e(number_format($totalPaguBelanja)); ?></span>
                </div>
                <div class="sum-pill green">
                    <span class="sum-pill-lbl">Realisasi</span>
                    <span class="sum-pill-val">Rp <?php echo e(number_format($totalRealisasiBelanja)); ?></span>
                </div>
                <div class="sum-pill green">
                    <span class="sum-pill-lbl">Sisa</span>
                    <span class="sum-pill-val" style="color:#e02424;">Rp <?php echo e(number_format($totalSisaBelanja)); ?></span>
                </div>
            </div>
            <div class="progress" style="height:6px;">
        ...
        <div class="acc-head" id="accPendHead" onclick="toggleAcc('pendapatan')">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                    ...
                    <p class="s-sub"><?php echo e(count($pendapatan)); ?> data &nbsp;•&nbsp; Klik untuk expand</p>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $pendapatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <tr>
                                    ...
                                    <td class="col-hide-xs"><span class="num pagu">Rp <?php echo e(number_format($item->pagu)); ?></span>
                                    </td>
                                    <td><span class="num real">Rp <?php echo e(number_format($real)); ?></span></td>
                                    <td class="col-hide-xs"><span class="num sisa">Rp <?php echo e(number_format($sisa)); ?></span></td>
                                    <td style="text-align:center;"><span
                                            class="pct-badge <?php echo e($cls); ?>"><?php echo e(number_format($pct, 1)); ?>%</span></td>
                                </tr>
        ...
        <div class="acc-head" id="accBelHead" onclick="toggleAcc('belanja')">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                    ...
                    <p class="s-sub"><?php echo e(count($belanja)); ?> data &nbsp;•&nbsp; Klik untuk expand</p>
                </div>
            </div>
            <div class="acc-toggle"><i class="fas fa-chevron-down"></i></div>
        </div>
                    ...
                    <div class="modal-content" style="border-radius:16px;border:none;overflow:hidden;">
                        ...
                        <div class="modal-body text-center p-3">
                            <?php $__currentLoopData = $item->dokumentasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e(asset('storage/' . $doc->file)); ?>" class="img-fluid rounded mb-3 shadow-sm"

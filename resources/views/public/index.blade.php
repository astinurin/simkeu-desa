            ...
            <div class="col-6 col-md-3">
                <div class="kpi-card">
                    ...
                    <div>
                        ...
                        <div class="kpi-val">Rp {{ number_format($totalRealisasiPendapatan + $totalRealisasiBelanja) }}
                        </div>
                        <div class="kpi-note">Pendapatan + Belanja</div>
                    </div>
                </div>
                ...
                <div class="s-head" style="flex-direction:row;align-items:center;padding-bottom:0;border-bottom:none;">
                    <div class="s-head-top">
                        ...
                        <div>
                            ...
                            <p class="s-sub">Perbandingan anggaran {{ $tahun }}</p>
                        </div>
                    </div>
                </div>
    ...
    <div class="s-card mb-3 a4" style="margin-top:24px;">
        ...
        <div class="s-head">
            <div class="s-head-top">
                ...
                <div>
                    ...
                    <p class="s-sub">Realisasi {{ number_format($persenPendapatan, 2) }}% dari total pagu</p>
                </div>
            </div>
            <div class="pill-row">
                <div class="pill p-blue">
                    <span class="pill-lbl">Total Pagu</span>
                    <span class="pill-val">Rp {{ number_format($totalPaguPendapatan) }}</span>
                </div>
                <div class="pill p-green">
                    <span class="pill-lbl">Realisasi</span>
                    <span class="pill-val">Rp {{ number_format($totalRealisasiPendapatan) }}</span>
                </div>
                <div class="pill p-red">
                    <span class="pill-lbl">Sisa</span>
                    <span class="pill-val">Rp {{ number_format($totalSisaPendapatan) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="prog-wrap">
            <div class="prog-lbl">
                ...
                <span>{{ number_format($persenPendapatan, 2) }}%</span>
            </div>
            <div class="progress">
        ...
        <div class="tbl-body">
            ...
            {{-- Keterangan kolom tersembunyi khusus HP --}}
                    ...
                    <tbody>
                        @forelse($pendapatan as $i => $item)
                            ...
                            <tr>
                                ...
                                <td class="col-hide-sm"><span class="num pagu">Rp {{ number_format($item->pagu) }}</span></td>
                                <td><span class="num real">Rp {{ number_format($real) }}</span></td>
                                <td class="col-hide-sm"><span class="num sisa">Rp {{ number_format($sisa) }}</span></td>
                                <td style="text-align:center;">
                                    <span class="pct {{ $pctCls }}">{{ number_format($pct, 2) }}%</span>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <div class="s-card mb-3 a5">
        ...
        <div class="s-head">
            <div class="s-head-top">
                ...
                <div>
                    ...
                    <p class="s-sub">Realisasi {{ number_format($persenBelanja, 2) }}% dari total pagu</p>
                </div>
            </div>
            <div class="pill-row">
                <div class="pill p-blue">
                    <span class="pill-lbl">Total Pagu</span>
                    <span class="pill-val">Rp {{ number_format($totalPaguBelanja) }}</span>
                </div>
                <div class="pill p-green">
                    <span class="pill-lbl">Realisasi</span>
                    <span class="pill-val">Rp {{ number_format($totalRealisasiBelanja) }}</span>
                </div>
                <div class="pill p-red">
                    <span class="pill-lbl">Sisa</span>
                    <span class="pill-val">Rp {{ number_format($totalSisaBelanja) }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="prog-wrap">
            <div class="prog-lbl">
                ...
                <span>{{ number_format($persenBelanja, 2) }}%</span>
            </div>
            <div class="progress">

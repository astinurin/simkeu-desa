                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?php echo e(route('belanja.show', $item->id)); ?>" class="btn btn-info btn-sm p-1"><i class="fas fa-eye"></i></a>
                                    <a href="<?php echo e(route('belanja.edit', $item->id)); ?>" class="btn btn-warning btn-sm p-1"><i class="fas fa-edit"></i></a>
                                    <form action="<?php echo e(route('belanja.destroy', $item->id)); ?>" method="POST" style="display:inline;">
